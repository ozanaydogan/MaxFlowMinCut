...
public class panel_5 extends JPanel {
	...
	public panel_5(int x,int[][]matris3,int[][]matrisxy) {
			
		this.matris1=matris3;
		this.matris2=matrisxy;
		
		success.setBounds(60,500,60,30);
		success.setText(Integer.toString(x));
		this.add(success);
